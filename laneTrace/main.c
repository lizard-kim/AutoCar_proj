...
#define DYNAMIC_OBS_START 20
#define DYNAMIC_OBS_END 50
#define DYNAMIC_OBS_WAIT 50
...
void * capture_thread(void *arg)
{
	...
	while(1) {
		...
		/**         data->highway = 2; */
		/**        } */
		/** } /// #highway_changed : at first, this car start at highway */
		/** else { */
