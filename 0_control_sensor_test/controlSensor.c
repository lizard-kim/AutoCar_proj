...
/****************************************************************************** 
 TODO:
 0cm, 10cm FINE TUNING, MAKE EACH FUNCTION OF PAL & T;
/*******************************************************************************
 *  Defines
 * 1 = front
 * 2 = right_front
...
void main(void)
{
    ...
    gain = SpeedPIDProportional_Read();
    gain = 50;
    SpeedPIDProportional_Write(gain);

    gain = SpeedPIDIntegral_Read();
    gain = 50;
    SpeedPIDIntegral_Write(gain);

    gain = SpeedPIDDifferential_Read();
    gain = 10;
    ...
    while(1)
    {
        ...
        {
            warmSensorTrigger_pal();
        }
        else if(channel == 3)
        {
            //warmSensorTrigger_tunnel();
            tunnel_adv();
        }
        else if(channel == 4)
        {
...
void warmSensorTrigger_pal()
{
    ...
    clock_t start_1=0, start_2=0, start_3=0, end_2 = 0;
    float endtime_1=0, endtime_2=0, endtime_3=0;


    if(parParkingSignal_2 == 0 && parParkingSignal_1 == 0 && O_data_2 < 30 && O_data_3 > 30)
    {
        start_2 = clock();
        parParkingSignal_1 = 1;
    }
    ...
    if(parParkingSignal_1 == 1 && O_data_2 > 30 && O_data_3 < 30)    
    {
        parParkingSignal_1 = 2;  
        end_2 = clock();
        float endtime_2 = (end_2-start_2)/CLOCKS_PER_SEC;
        printf("endtime_2 : %d\n", endtime_2);
        if(endtime_2 > 10)
        {
            parParkingSignal_1 = 0;
...
void parparking_adv()
{
    ...
    while(1)
    {
        if(EncoderCounter_Read() < -1300) // or EncoderCounter_Read == -6000; it means car moved 30cm.
        {
            DesireSpeed_Write(0);
            //SteeringServoControl_Write(1500);
            //SteeringServoControl_Write(1500);
    ...
    SteeringServoControl_Write(1001);
    DesireSpeed_Write(100);
    usleep(1000000); // maximum right steering
    */
    ...
    */
    ...
    while(1)
    {
        if(EncoderCounter_Read() > 1000) // or EncoderCounter_Read == -6000; it means car moved 30cm.
        {
            DesireSpeed_Write(0);
            //SteeringServoControl_Write(1500);
            break;
...
*/
    ...
    */
    ...
    while(1)
    {
        if(EncoderCounter_Read() < -1100) // or EncoderCounter_Read == -6000; it means car moved 30cm.
        {
            DesireSpeed_Write(0);
            //SteeringServoControl_Write(1500);
            break;
    ...
    */
    ...
    while(1)
    {
        if(EncoderCounter_Read() > 1800) // or EncoderCounter_Read == -6000; it means car moved 30cm.
        {
            DesireSpeed_Write(0);
            //SteeringServoControl_Write(1500);
            break;
    ...
    */
    ...
    while(1)
    {
        if(EncoderCounter_Read() > 2200) // or EncoderCounter_Read == -6000; it means car moved 30cm.
        {
            DesireSpeed_Write(0);
            //SteeringServoControl_Write(1500);
            break;
